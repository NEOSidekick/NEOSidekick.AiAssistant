...
class ConfigurationControllerSigningKeyTest extends TestCase
{
    ...
    public function theReenrolmentCheckboxIsPassedToTheRotationAndReportedAsSuch(): void
    {
        ...
        $this->regenerate($controller, true);
    ...
    public function theRelabelFormIsPassedToTheRotationAndReportedWithItsOwnOutcome(): void
    {
        ...
        $this->regenerate($controller, false, true);
    ...
    public function askingForAReenrolmentAndARelabelAtOnceIsRefusedBeforeAnyRotation(): void
    {
        ...
        $this->regenerate($controller, true, true);
    ...
    public function aFailedRelabelClearsThePendingRelabelFlagAndAPlainFailureDoesNot(): void
    {
        ...
        $this->regenerate($this->createController($pushService, $keyPairService, translation: null), false, true);
        ...
        $this->regenerate($this->createController($plainPushService, $plainKeyPairService, translation: null));
    }
    ...
    /**
     * Runs the action up to its redirect, which the test double turns into a stop like Flow's own.
     */
    private function regenerate(ConfigurationController $controller, bool $reenrol = false, bool $relabel = false): void
    {
        try {
            $controller->regenerateSigningKeyAction($reenrol, $relabel);
        } catch (RuntimeException $exception) {
            if ($exception->getCode() !== 1757600001) {
                throw $exception;
            }
        }
    }
    ...
    private function createController(
        ...
        $controller = new class () extends ConfigurationController {
            public const REDIRECT_STOPS_ACTION = 1757600001;
            ...
            protected function redirect($actionName, $controllerName = null, $packageKey = null, array $arguments = [], $delay = 0, $statusCode = 303, $format = null): never
            {
                ...
                // Flow 9 declares redirect() as never returning, so the double stops the action like Flow does.
                throw new RuntimeException('redirected to ' . $actionName, self::REDIRECT_STOPS_ACTION);
            }
